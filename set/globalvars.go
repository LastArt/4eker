...
var (
	...
	BOT_WARNING_DELUSER_INFO          string = "ℹ️Для того чтобы удалить сотрудника введите №карты удаляемого сотрудника \n"
	...
	BOT_WARNING_DELADMIN_INFO         string = "ℹ️Для того чтобы удалить администратора введите ID \n"
